  ...
  return (
    <section id="sobre" className="py-20 md:py-32 border-t border-border bg-secondary/10">
      <div className="container grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
        ...
        {/* Foto real + badge CEO */}
        <AnimatedSection>
          <motion.div variants={fadeUp} className="relative max-w-sm mx-auto lg:max-w-none">
            <div className="aspect-[3/4] sm:aspect-[4/5] lg:aspect-[3/4] rounded-2xl overflow-hidden relative">
              <Image
